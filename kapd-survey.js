...
(function () {
  const QUESTIONS = [
    ...
    { section: 'Блок 6. Итоговые выводы', id: 20, text: 'Как вы считаете, нужен ли был такой сайт для исследования?', options: ['Да, сайт наглядно показал разницу между человеком и ИИ', 'Свой ответ'], customLast: true },
  ];
